...
unzip(zipfile = pg_record[[1]]$path, 
      ...
      overwrite = TRUE, 
      exdir = here::here("analysis", "data", "raw_data"))

mining_pol <- sf::st_read(
  dsn = here::here("analysis", "data", "raw_data", "global_mining_polygons_v1.gpkg"),
  fid_column_name = "FID",
  stringsAsFactors = FALSE,
  query = "SELECT geom, COUNTRY_NAME, ISO3_CODE, AREA FROM mining_polygons") 
...
mining_com_path <- here::here("analysis", "data", "raw_data", "mining_commodities.gpkg")
